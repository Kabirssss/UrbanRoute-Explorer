  ...
  useEffect(() => {
    ...
    intro.setOptions({
      steps:[
        {
            element:"#map",
            intro:"Welcome to UrbanRoute Explorer – a project dedicated to calculating the shortest paths and visualizing optimal routes in real-world scenarios. Join us on a journey to explore efficient navigation and gain deeper insights into spatial pathfinding."
        },
        {
            element: "#open",
